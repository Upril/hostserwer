...
public class DataLoader implements CommandLineRunner {
    ...
    private void loadSeriesData() throws IOException {
        if(seriesRepository.count() == 0){
            ...
            Series series4 = new Series(4L, "Jojo's Bizarre Adventure", "Jojo's Bizarre Adventure: Epic generational battles of Joestar family against supernatural foes with unique powers. Eccentric characters, mind-bending plot. Legendary manga/anime.",null,null,null,image);
            Series series5 = new Series(5L, "Naruto Shippuden", "Continuation of Naruto's journey as he trains to become a powerful ninja, facing formidable enemies, uncovering secrets, and protecting his village. Action-packed, emotional, and explores themes of friendship and perseverance.",null,null,null,image);
            Series series6 = new Series(6L, "Death Note", "Genius student Light Yagami discovers a supernatural notebook that kills anyone whose name is written in it. He seeks to create a new world order, engaging in a gripping cat-and-mouse game with detective L. Intense mind games and a psychological thriller",null,null,null,image);
            Series series7 = new Series(7L, "Attack on Titan", "Humanity fights for survival against giant humanoid creatures called Titans. Eren Yeager and his friends join the military to uncover the mysteries of the Titans and protect what remains of humanity.",null,null,null,image);
            Series series8 = new Series(8L, "Demon Slayer", "Tanjiro Kamado becomes a demon slayer after his family is slaughtered and his sister transformed into a demon. With a blade forged from tragedy, he embarks on a quest to avenge his family and find a cure for his sister.",null,null,null,image);
            Series series9 = new Series(9L, "One Piece", "Monkey D. Luffy sets sail with his crew, the Straw Hat Pirates, in search of the ultimate treasure, the One Piece, while battling powerful foes, exploring diverse islands, and forming alliances.",null,null,null,image);
            Series series10 = new Series(10L, "Fullmetal Alchemist: Brotherhood", "Two brothers, Edward and Alphonse Elric, use alchemy in their quest to find the Philosopher's Stone and restore their bodies. They face political intrigue, moral dilemmas, and encounters with powerful alchemists.",null,null,null,image);
